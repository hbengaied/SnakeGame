...
namespace SnakeGame
{
    /* La classe Server et Client utilisent les méthodes asynchrones de la classe Socket. En effet, les méthodes
    ...
    public class Server
    {
        /* La classe Server a été créée pour simplifier la gestion des connexion grâce à la mise à disposition
        ...
        {
            /* La contruction d'un Server consiste à définir son interface (ip et port) d'écoute.
